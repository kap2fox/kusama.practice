...
module.exports = function (
    ...
    const sectionsContent = path.reduce((prev, next) =>{
      return `${prev}\n<div class="section"><h2>${next}</h2></div>`
    }, '')
    const template = `
    <html>
    <head>
